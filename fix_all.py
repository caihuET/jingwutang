...
for k, v in {"game.html":"江湖首页","player.html":"角色信息","equipment.html":"背包行囊","skills.html":"武学技能","meridians.html":"经脉修炼","battle.html":"闯荡江湖","tasks.html":"任务","ranking.html":"排行榜","shop.html":"商城"}.items():
    c = re.sub(r"href.'/game/jwt/" + k + r"',\s*label.'[^']*'", "href:'/game/jwt/" + k + "', label:'" + v + "'", c)
open("static/js/common.js", "w", encoding="utf-8").write(c)
print("3/6 common OK")

c = open("static/js/skills.js", encoding="utf-8").read()
old = c
c = c.replace(""技能#"" + chr(39) + " + s.skill_id", "s.name || " + chr(39) + "技能#" + chr(39) + " + s.skill_id")
open("static/js/skills.js", "w", encoding="utf-8").write(c)
print("4/6 skills.js OK")
